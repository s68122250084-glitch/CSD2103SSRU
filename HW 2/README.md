...
ผลลัพธ์อาจแตกต่างกันได้ แต่ต้องแบ่งข้อมูลตามเงื่อนไขถูกต้อง
...
ใช้อัลกอริทึมแบบเวียนเกิด (Recursion) ร่วมกับตัวชี้สองตำแหน่ง คือ left และ right

- ถ้าค่าด้านซ้าย ≤ k ให้เลื่อน left
- ถ้าค่าด้านขวา > k ให้เลื่อน right
- ถ้าพบค่าที่อยู่ผิดด้าน ให้สลับข้อมูล
...
- อาจเกิด StackOverflowError หากข้อมูลมีขนาดใหญ่มาก
...
ใช้ตัวชี้สองตำแหน่งเหมือน Recursive แต่ใช้ลูป while แทนการเรียกเมธอดซ้ำ
...
## เหตุผลที่ไม่ใช้การเรียงลำดับ (Sorting)

การเรียงลำดับทั้งอาร์เรย์ใช้เวลาอย่างน้อย **O(n log n)** ในขณะที่การแบ่งข้อมูลตามค่า k ต้องการเพียงแยกข้อมูลออกเป็นสองกลุ่ม จึงใช้การแบ่งแบบ Partition ซึ่งทำงานได้ในเวลา **O(n)** และมีประสิทธิภาพมากกว่า

## ความสัมพันธ์กับ Quick Sort

อัลกอริทึมนี้ใช้หลักการเดียวกับขั้นตอน **Partition** ใน Quick Sort คือแบ่งข้อมูลออกเป็นสองส่วนตามเงื่อนไข โดยไม่จำเป็นต้องเรียงลำดับข้อมูลทั้งหมด

## In-place Algorithm

ทั้ง Recursive Partition และ Iterative Partition เป็น **In-place Algorithm** เพราะทำงานกับอาร์เรย์เดิมโดยไม่ต้องสร้างอาร์เรย์ใหม่

---

# สรุป

Recursive Partition เหมาะสำหรับการศึกษาหลักการ Recursion และการแบ่งข้อมูลแบบ In-place แต่มีข้อจำกัดเรื่องการใช้หน่วยความจำและอาจเกิด StackOverflowError

Iterative Partition เหมาะสำหรับการใช้งานจริง เนื่องจากมี Time Complexity เท่ากันคือ **O(n)** แต่ใช้ Space Complexity เพียง **O(1)** ทำงานได้รวดเร็วกว่าและรองรับข้อมูลขนาดใหญ่ได้ดีกว่า
